            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0, marginLeft: 8 }}>
                  ...
                  {user?.role === "CEO" && (
                    <button onClick={async (e) => { e.stopPropagation(); if (!window.confirm(`Delete lead "${lead.company}"? This cannot be undone.`)) return; const { error } = await supabase.from("leads").delete().eq("id", lead.id); if (error) { alert("Delete failed: " + error.message); return; } if (selectedLead?.id === lead.id) setSelectedLead(null); load(); }}
